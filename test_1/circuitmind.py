...
def open_camera():
    """Open first working camera. Returns (VideoCapture, index)."""
    ...
    for idx in CAMERA_INDICES:
        ...
        if cap.isOpened():
            ...
            if ret:
                ...
                print(f"OK  ({w}×{h})")
                print(f"[Camera] ✓ Using /dev/video{idx} — IPEVO V4K")
                return cap, idx
            cap.release()
        print("failed")
    print("[Camera] ✗ No camera found. Run Milestone 1 to diagnose.")
    sys.exit(1)
